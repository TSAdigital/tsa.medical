...
$this->title = 'История: ' . StringHelper::truncate($model->description, 45, '...');
$this->params['breadcrumbs'][] = ['label' => 'Роли', 'url' => ['index']];
$this->params['breadcrumbs'][] = ['label' => StringHelper::truncate($model->description, 50, '...'), 'url' => ['view', 'id' => $model->id]];

...
$disabled_create = (Yii::$app->user->can('departmentCreate') or Yii::$app->user->can('admin')) ?: 'disabled';
                    ...
                    <?= GridView::widget([
                        ...
                        'columns' => [
                            ...
                            [
                                ...
                                'value' => function($data)
                                {
                                    return (Yii::$app->user->can('departmentView') or Yii::$app->user->can('admin')) ? Html::a($data->name, ['departments/view','id'=>$data->id], ['title' => 'View','class'=>'no-pjax']) : $data->name;
                                }
                            ],
                            [

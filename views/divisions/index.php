...
$disabled_create = (Yii::$app->user->can('divisionCreate') or Yii::$app->user->can('admin')) ?: 'disabled';
                    ...
                    <?= GridView::widget([
                        ...
                        'columns' => [
                            ...
                            [
                                ...
                                'value' => function($data)
                                {
                                    return (Yii::$app->user->can('divisionView') or Yii::$app->user->can('admin')) ? Html::a($data->name, ['divisions/view','id'=>$data->id], ['title' => 'View','class'=>'no-pjax']) : $data->name;
                                }
                            ],
                            [
                            ...
                            [
                                'filter' => Division::getStatusesArray(),
                                'attribute' => 'status',
                                'options' => ['width'=>'20%'],
                                ...
                                'value' => function ($model, $key, $index, $column) {
                                    ...
                                    switch ($value) {
                                        case Division::STATUS_ACTIVE:
                                            $class = 'success';
                                            break;
                                        case Division::STATUS_INACTIVE:
                                            $class = 'danger';
                                            break;
                                        default:
                                            $class = 'default';

...
$disabled_create = (Yii::$app->user->can('specializationCreate') or Yii::$app->user->can('admin')) ? NULL : ' disabled';
                    ...
                    <?= GridView::widget([
                        ...
                        'columns' => [
                            ...
                            [
                                ...
                                'value' => function($data)
                                {
                                    return (Yii::$app->user->can('specializationView') or Yii::$app->user->can('admin')) ? Html::a($data->name, ['specializations/view','id'=>$data->id], ['title' => 'View','class'=>'no-pjax']) : $data->name;
                                }
                            ],
                            [

...
$this->title = StringHelper::truncate($model->firs_name . ' ' . $model->last_name . ' ' . $model->middle_name, 50, '...');
$this->params['breadcrumbs'][] = ['label' => 'Контрагенты ЮЛ', 'url' => ['index']];
$this->params['breadcrumbs'][] = ['label' => StringHelper::truncate($model->firs_name . ' ' . $model->last_name . ' ' . $model->middle_name, 30, '...'), 'url' => ['view', 'id' => $model->id]];

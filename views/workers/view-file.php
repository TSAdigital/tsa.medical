...
$disabled_downloads = (Yii::$app->user->can('fileView') or Yii::$app->user->can('admin')) ? NULL : ' disabled';
$disabled_update = (Yii::$app->user->can('fileUpdate') or Yii::$app->user->can('admin')) ? NULL : ' disabled';
$disabled_block = (Yii::$app->user->can('fileBlocked') or Yii::$app->user->can('admin')) ? NULL : ' disabled';
$disabled_active = (Yii::$app->user->can('fileActive') or Yii::$app->user->can('admin')) ? NULL : ' disabled';
$this->params['buttons'] = [

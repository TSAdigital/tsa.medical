...
$this->params['buttons'] = [
    'downloads' => ($file->status == 10 and file_exists($file->url)) ? Html::a('<i class="fas fa-download text-success"></i>Скачать файл', ['workers/download', 'id'=> $file->id], ['class' => 'btn btn-app']) : false,

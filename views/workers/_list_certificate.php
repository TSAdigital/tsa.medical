...
<tr>
    ...
    <td class="text-center align-middle">
        <?= (Yii::$app->user->can('certificateView') or Yii::$app->user->can('admin')) ? Html::a('<i class="fas fa-sign-in-alt text-muted"></i>', ['view-certificate', 'id'=> $worker->id, 'certificate' => $model->id], ['class' => 'btn m-0 p-0']) : Html::a('<i class="fas fa-sign-in-alt text-muted"></i>', ['view-certificate', 'id'=> $worker->id, 'certificate' => $model->id], ['class' => 'btn disabled m-0 p-0']) ?>
    </td>
</tr>

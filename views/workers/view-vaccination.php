...
$this->params['buttons'] = [
    'update' => $vaccination->status == 10 ? Html::a('<i class="fas fa-edit text-primary"></i>Редактировать', ['update-vaccination', 'id' => $model->id, 'vaccination' => $vaccination->id], ['class' => 'btn btn-app']) : false,

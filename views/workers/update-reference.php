...
$this->title = 'Редактирование: справки ' . StringHelper::truncate($reference->getReference_type_name(), 30, '...');
...
$this->params['breadcrumbs'][] = ['label' => StringHelper::truncate($reference->getReference_type_name(), 12, '...'), 'url' => ['view-reference', 'id' => $model->id, 'reference' => $reference->id]];
